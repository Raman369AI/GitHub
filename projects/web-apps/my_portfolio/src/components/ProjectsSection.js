...
const projects = [
  {
    ...
    description: [
      "Engineered a sophisticated Multi-Agent System that clears the GAIA Benchmark, demonstrating advanced capabilities in agent-based problem-solving.",
    "Achieved a 50% success rate in solving complex tasks, showcasing the system's robustness and adaptability.",
  "Utilized Google's Agent Development Kit and Vertex AI to solve the benchmark, leveraging state-of-the-art tools for optimal performance.",],
    getImageSrc: () => require("../images/gaia.jpg"),
    url: "https://github.com/Raman369AI/Agents",
  },
  {
    title:
...
const ProjectsSection = () => {
  ...
  return (
    ...
    >
      ...
      >
        <Center w="100%">
          <Heading as="h1" id="projects-section" color = "black" margin={10}>
            Featured Projects
          </Heading>
        </Center>
        <Box
